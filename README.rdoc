...
== v1.0 DOCUMENTATION PENDING REWRITE

The DoesFacebook gem is undergoing an API rewrite and reconfiguration for v1.0. The documentation
below is for prior versions of this gem. While largely accurate, significant changes to the codebase
will make much of it obsolete.
